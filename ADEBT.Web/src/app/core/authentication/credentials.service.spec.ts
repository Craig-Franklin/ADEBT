...
describe('CredentialsService', () => {
  ...
  describe('setCredentials', () => {
    it('should authenticate user if credentials are set', () => {
      // Act
      credentialsService.setCredentials({ username: 'me', token: '123', firstName: 'me', lastName: 'me' });
    ...
    it('should persist credentials across sessions', () => {
      // Act
      credentialsService.setCredentials({username: 'me', token: '123', firstName: 'me', lastName: 'me'}, true);
